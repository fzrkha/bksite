        ...
        <div class="row gx-lg-5 align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
                ...
                <p style="color: hsl(200, 2%, 26%)">
                    Aplikasi ini dibuat untuk membantu guru BK dalam mendata
            ...
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="card">
                    <div class="card-body py-5 px-md-5">
                        <h1 class="my-3 display-5 fw-bold ls-tight text-primary">Verifikasi</h1>
                        <form action="" method="POST">
                            @csrf
                            <div class="form-outline mb-4">
                                <label class="form-label">Username</label>
                                <input type="text" name="username" value="{{old('userame')}}" class="form-control">
                            </div>
                            <div class="form-outline mb-4">
